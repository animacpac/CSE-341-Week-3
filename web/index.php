                ...
                <form action="manage_cart.php" method="POST">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            ...
                            <input type="hidden" name="Item-Name" value="Purse 1">
                ...
                <form action="manage_cart.php" method="POST">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            ...
                            <button type="submit" name="Add_To_Cart" class="btn btn-info">Add To Cart</button>
                            <input type="hidden" name="Item-Name" value="Purse 2">
                ...
                <form action="manage_cart.php" method="POST">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            ...
                            <button type="submit" name="Add_To_Cart" class="btn btn-info">Add To Cart</button>
                            <input type="hidden" name="Item-Name" value="Purse 3">
                ...
                <form action="manage_cart.php" method="POST">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            ...
                            <button type="submit" name="Add_To_Cart" class="btn btn-info">Add To Cart</button>
                            <input type="hidden" name="Item-Name" value="Purse 4">
